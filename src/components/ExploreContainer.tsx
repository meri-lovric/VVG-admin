...
class ExploreContainer extends React.Component<
  ...
  async componentDidMount() {
    try {
      let allTodos = await API.graphql({ query: queries.listReports });
      // @ts-ignore
      let posts = allTodos.data.listReports.items;
                ...
                return (
                  <div key={index}>
                    <IonCard>
                      ...
                      <IonCardContent className="order-subtitle-desc">
                        {_element[1][0].description}
                      </IonCardContent>
                    </IonCard>
                    {/* 
